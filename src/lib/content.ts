    ...
    members: [
      {
        ...
        desc: {
          ...
          es: "Diagnostica tu negocio, define la hoja de ruta operativa y lidera el proyecto de principio a fin. Convierte tus problemas reales en soluciones estructuradas, enfocadas en tus objetivos, no solo en los síntomas.",
        },
